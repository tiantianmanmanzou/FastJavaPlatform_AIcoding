    ...
    <div className="page-shell">
      {title && (
        <header className="page-header">
          ...
          {headerExtra && <div className="page-header-actions">{headerExtra}</div>}
        </header>
      )}

      <div className="page-stack">
        {(showSearch || showAction || showOperationButtons || extraActions || headerExtra) && (
        ...
        <Card className="page-panel filter-panel">
